...
import GUI.Events.ThirdPanelEvents.DeleteProduct;
...
public class DeleteProductPanel extends JPanel {
    ...
    private final JButton CONFIRM = Component.getButton(185,160,140,40,"CONFIRM DELETE");
    private final Panel_ProductAdmin parentPanel;
    public DeleteProductPanel(Panel_ProductAdmin parentPanel) {
    ...
    private void setEvents() {
        CONFIRM.addMouseListener(new DeleteProduct(this));
    }
